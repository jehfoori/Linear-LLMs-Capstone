...
RESULT_ROOT=${RESULT_ROOT:-results/hazy_context_sweep_n20_l512_2560}
...
echo "Started HazyResearch context sweep n20 run at $(date -Is)"
...
generate_dataset configs/dataset_context_sweep_single_n20_l512_2560.yaml datasets/context_sweep_single_n20_l512_2560_gpt2tok.jsonl
generate_dataset configs/dataset_context_sweep_multikey_d20_n20_l512_2560.yaml datasets/context_sweep_multikey_d20_n20_l512_2560_gpt2tok.jsonl

for task in single_needle multi_key; do
  case "$task" in
    single_needle) dataset_path=datasets/context_sweep_single_n20_l512_2560_gpt2tok.jsonl ;;
    multi_key) dataset_path=datasets/context_sweep_multikey_d20_n20_l512_2560_gpt2tok.jsonl ;;
...
echo
echo "Finished HazyResearch context sweep n20 run at $(date -Is)"
