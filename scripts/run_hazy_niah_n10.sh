...
RESULT_ROOT=${RESULT_ROOT:-results/hazy_niah_n10}
...
echo "Started HazyResearch NIAH run at $(date -Is)"
...
generate_dataset configs/dataset_hazy_single_n10.yaml datasets/hazy_single_n10_gpt2tok.jsonl
generate_dataset configs/dataset_hazy_d5_n10.yaml datasets/hazy_d5_n10_gpt2tok.jsonl
generate_dataset configs/dataset_hazy_d20_n10.yaml datasets/hazy_d20_n10_gpt2tok.jsonl

for setting in single d5 d20; do
  case "$setting" in
    single) dataset_path=datasets/hazy_single_n10_gpt2tok.jsonl ;;
    d5) dataset_path=datasets/hazy_d5_n10_gpt2tok.jsonl ;;
    d20) dataset_path=datasets/hazy_d20_n10_gpt2tok.jsonl ;;
...
echo
echo "Finished HazyResearch NIAH run at $(date -Is)"
